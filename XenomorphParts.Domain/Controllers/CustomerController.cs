...
namespace XenomorphParts.Domain.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        // GET api/customer/getbyname/Puldark Station
        [HttpGet("{name}")]
        ...
        // GET api/customer/getbylocation/1234567
        [HttpGet("{location}")]
        ...
        // GET api/customer/getbysystem/Yabin
        [HttpGet("{system}")]
        ...
        // GET api/customer/getbyplanet/Puldark
        [HttpGet("{planet}")]
        ...
        // GET api/customer/getbyregion/United States of Puldark
        [HttpGet("{region}")]
