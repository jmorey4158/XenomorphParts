...
namespace XenomorphParts.Domain.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        private static EntityType type = EntityType.Supplier;
